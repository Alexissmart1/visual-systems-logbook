...
In this laboratory session, you will explore techniques to identify features and regions in an image. 
...
montage({f, g1, g2, g3});
```
<img width="1160" height="1013" alt="image" src="https://github.com/user-attachments/assets/70b5f5da-ab16-492e-bbb1-1fdccfa9ccca" />
Notes: 
from the output image we can see a montage of repeated processes to reduce the size of the points on the image using the erode function. The main central nebula has been removed and in the last image we can
see that only the largest/ most intense stars remain from the original image, however they are much reduced.
